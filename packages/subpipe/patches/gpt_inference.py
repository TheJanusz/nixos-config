# Upstream-compatible GPT2InferenceModel for transformers>=4.52 / 5.x
# (idiap/coqui-ai-TTS PR #414 / #550): drop custom prepare_inputs_for_generation so
# GenerationMixin handles DynamicCache correctly. Without this, XTTS audio is garbled.
import torch
